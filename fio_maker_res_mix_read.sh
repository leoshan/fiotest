...
rm -rf fio_res_output_mix_read.txt
...
do
	...
	iops=`head -n 16 $i|grep iops | awk -F',' '{print $3}' |awk -F'=' '{print $2}'`
        bw=`head -n 16 $i|grep iops  | awk -F',' '{print $2}' |awk -F'=' '{print $2}'`
        bwdata=`head -n 16 $i |grep iops | awk -F',' '{print $2}' |awk -F'=' '{print $2}'|awk -F"[KM]" '{print $1}'`
        bwunit=${bw:0-4:4}
	

        delaydata=`head -n 16 $i |grep -w lat  | grep -w avg | awk -F',' '{print $3}'|awk -F'=' '{print $2}'`
        delayunit=`head -n 16 $i |grep -w lat  | head -n 1 | awk -F'(' '{print $2}' |  awk -F')' '{print $1}'`

        clat_50=`head -n 16 $i |grep 50.00th  | awk -F',' '{print $3}' |awk -F'[' '{print $2}'|awk -F']' '{print $1}'`
        clat_90=`head -n 16 $i |grep 90.00th | awk -F',' '{print $3}' |awk -F'[' '{print $2}'|awk -F']' '{print $1}'`
        clat_99=`head -n 16 $i |grep 99.00th | awk -F',' '{print $1}' |awk -F'[' '{print $2}'|awk -F']' '{print $1}'`
        clat_9995=`head -n 16 $i |grep 99.95th  | awk -F',' '{print $4}' |awk -F'[' '{print $2}'|awk -F']' '{print $1}'`
...
cat fio_res_output_mix_read.txt
